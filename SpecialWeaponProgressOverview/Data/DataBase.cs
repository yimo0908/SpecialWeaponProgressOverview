...
public static class DataBase
{
    ...
    /// <summary>义武各阶段材料配方：每阶段对应 (ItemId, 数量) 列表。</summary>
    public static readonly List<List<(uint ItemId, int Count)>> BozjaMaterialRecipes =
    [
        [(30273, 4)],                                           // 义军武器      — 萨维奈灵鳞粉
        [(31573, 20), (31574, 20), (31575, 20)],                // 烦恼的记忆晶块
        [(31576, 6)],                                           // 回忆          — 悲伤/恐惧/勇猛的记忆晶块
        [(32956, 15)],                                          // 裁决          — 厌恶的记忆晶块
        [(32959, 15)],                                          // 改良型裁决    — 被丢掉的遗物
        [(33767, 15)],                                          // 女王武器      — 光辉的记忆晶块
    ];

    /// <summary>曼武各阶段材料配方：每阶段对应 (ItemId, 数量) 列表。</summary>
    public static readonly List<List<(uint ItemId, int Count)>> MandervillousMaterialRecipes =
    [
        [(38420, 3)],   // 曼德维尔武器        — 稀少陨石
        [(38940, 3)],   // 曼德维尔武器·惊异   — 稀少球粒陨石
        [(40322, 3)],   // 曼德维尔武器·威严   — 稀少无球粒陨石
        [(41032, 3)],   // 曼德维尔武器·盈满   — 雏晶
    ];
    ...
    public static readonly List<List<(uint ItemId, int Count)>> EurekaMaterialRecipes =
    [
        [(21801, 100)],                    // 阶段0  禁地兵装        — 乱属性水晶
        [(21801, 400)],                    // 阶段1  禁地兵装+1      — 乱属性水晶
        [(21801, 800)],                    // 阶段2  禁地兵装+2      — 乱属性水晶
        [(21802, 3)],                      // 阶段3  常风            — 帕祖祖的羽毛
        [(23309, 5), (22976, 500)],        // 阶段4  恒冰            — 结冰乱属性水晶 + 恒冰水晶
        [(23309, 10)],                     // 阶段5  恒冰+1          — 结冰乱属性水晶
        [(23309, 16), (22975, 5)],         // 阶段6  元素            — 结冰乱属性水晶 + 娄希的冰片
        [(24124, 150)],                    // 阶段7  元素+1          — 涌火水晶
        [(24124, 200)],                    // 阶段8  元素+2          — 涌火水晶
        [(24124, 300), (24123, 5)],        // 阶段9  涌火            — 涌火水晶 + 彭忒西勒亚的火种
        [(24807, 50)],                     // 阶段10 丰水            — 丰水水晶
        [(24807, 100)],                    // 阶段11 丰水+1          — 丰水水晶
        [(24807, 100)],                    // 阶段12 新兵装          — 丰水水晶
        [(24807, 100), (24806, 5)],        // 阶段13 优雷卡          — 丰水水晶 + 水晶龙之鳞
        [(24808, 100)],                    // 阶段14 优雷卡·改       — 优雷卡的断片
    ];
}
